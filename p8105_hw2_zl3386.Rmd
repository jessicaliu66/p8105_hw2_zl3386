...
* The resulting dataset `ad_df` contains the data of `r nrow(ad_df)` participants who appear in both datasets, including their basic demographic information (`id`,  `baseline_age`, `sex`, `education` (years) ), APOE4 carrier status (`apoe4`), `age_at_onset` of MCI and amyloid β 42/40 ratio over time (`baseline`,  `time_2`, `time_`4, `time_6`, `time_8`).
